            ...
            <div class="container">
                <div class="profile-edit-wrapper">
                    <div class="row gy-5">
                        ...
                        <div class="col-xl-5">
                            <h2 class="section-header__title" style={{ fontSize: "19px" }}>CHOOSE BETTING AMOUNT IN CST COIN</h2>
                        ...
                        <div class="col-xl-7">
                            <div class="section-header text-center">
                                <h2 class="section-header__title" style={{ fontSize: "19px" }}>IF YOU BET 100 CST COIN (MIN BET 1, MAX BET 40,000)</h2>
